    ...
    <div class="col-lg-12 mb-lg-0 mb-4">
        <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
                ...
                <a href="{{ route('penulis.create') }}" class="btn btn-primary btn-sm ml-auto">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('penulis.destroy', $row->id) }}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
                                            ...
                                            <a href="{{ route('penulis.edit', $row->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('penulis.update', $data->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="kategori">Nama Kategori</label>
                        <input type="text" name="nama_penulis" value="{{ $data->nama_penulis }}" class="form-control" id="text" placeholder="Enter Kategori">
